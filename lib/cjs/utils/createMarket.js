...
class MarketV2 extends base_1.Base {
    ...
    static makeCreateMarketInstruction({ connection, wallet, marketInfo, space, }) {
        return __awaiter(this, void 0, void 0, function* () {
            const ins1 = [];
            ...
            ins2.push(web3_js_1.SystemProgram.createAccountWithSeed({
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(space.requestQueueSpace),
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(space.eventQueueSpace),
                ...
                lamports: yield connection.getMinimumBalanceForRentExemption(space.orderbookLength),
