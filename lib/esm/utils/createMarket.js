...
export class MarketV2 extends Base {
    ...
    tickSize, // 0.01
    dexProgramId, makeTxVersion, lookupTableCache, space, }) {
    ...
    static async makeCreateMarketInstruction({ connection, wallet, marketInfo, space, }) {
        const ins1 = [];
        ...
        ins2.push(SystemProgram.createAccountWithSeed({
            ...
            lamports: await connection.getMinimumBalanceForRentExemption(space.requestQueueSpace),
            space: space.requestQueueSpace,
            programId: marketInfo.programId,
        }), SystemProgram.createAccountWithSeed({
            fromPubkey: wallet,
            basePubkey: wallet,
            ...
            lamports: await connection.getMinimumBalanceForRentExemption(space.eventQueueSpace),
            space: space.eventQueueSpace,
            programId: marketInfo.programId,
        }), SystemProgram.createAccountWithSeed({
            fromPubkey: wallet,
            basePubkey: wallet,
            ...
            lamports: await connection.getMinimumBalanceForRentExemption(space.orderbookLength),
            space: space.orderbookLength,
            programId: marketInfo.programId,
        }), SystemProgram.createAccountWithSeed({
            fromPubkey: wallet,
            basePubkey: wallet,
